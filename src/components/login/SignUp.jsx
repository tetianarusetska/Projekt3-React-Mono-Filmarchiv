    ...
    return (
        ...
        >
            ...
            <div className="flex justify-center">
                <button
                    type="submit"
                    className="rounded-md mt-5 w-42.5 h-10 flex items-center justify-center gap-2 text-(--mainColor) backdrop-blur-md bg-(--mainColor)/5 border border-(--mainColor)/20 shadow-lg transition-all duration-300 hover:bg-(--mainColor)/10 hover:scale-[1.03] active:scale-[0.98]"
                >
                    Registrieren
                </button>
            </div>
